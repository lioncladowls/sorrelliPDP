...
(function() {
  ...
  // ── Page registry ──
  var pages = {
    'pdp-v5.html':                { group: 'product', label: 'Mockup — V5' },
    ...
    'cart-v5.html':               { group: 'cart',    label: 'Mockup — V5' },
  ...
  var html = ''
    ...
    + '          <a href="pdp-v5.html" class="preview-nav__dropdown-link preview-nav__dropdown-link--sub' + activeLinkIf(filename === 'pdp-v5.html') + '">V5 <span class="preview-nav__current-tag">Current</span></a>'
    + '          <a href="pdp-v4.html" class="preview-nav__dropdown-link preview-nav__dropdown-link--sub' + activeLinkIf(filename === 'pdp-v4.html') + '">V4</a>'
    + '          <a href="pdp-v3.html" class="preview-nav__dropdown-link preview-nav__dropdown-link--sub' + activeLinkIf(filename === 'pdp-v3.html') + '">V3</a>'
    ...
    + '        <div class="preview-nav__dropdown">'
    + '          <span class="preview-nav__dropdown-label">Mockup</span>'
    + '          <a href="cart-v5.html" class="preview-nav__dropdown-link preview-nav__dropdown-link--sub' + activeLinkIf(filename === 'cart-v5.html') + '">V5 <span class="preview-nav__current-tag">Current</span></a>'
    + '          <a href="cart-v4.html" class="preview-nav__dropdown-link preview-nav__dropdown-link--sub' + activeLinkIf(filename === 'cart-v4.html') + '">V4</a>'
  ...
  if (drawerBtn) {
    drawerBtn.addEventListener('click', function() {
      ...
      if (drawer && backdrop) {
        ...
        window.location.href = 'cart-v5.html?drawer=1';
      }
    });
  }
})();
